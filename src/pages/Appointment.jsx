...
//     for (let i = 0; i < 7; i++){
//       //obteniendo fecha con índice
//       let currentDate = new Date(today)
//       currentDate.setDate(today.getDate() + i)

//       // Verifica si el día es de lunes (0) a viernes (4)
//     const dayOfWeek = currentDate.getDay()
//     if (dayOfWeek < 0 || dayOfWeek > 4) continue // saltar si es sábado o domingo
      
//     //establecer la hora de finalización de la fecha con índice
//     let endTime = new Date()
//     endTime.setDate(today.getDate() + i)
//     endTime.setHours(21, 0, 0, 0)
...
//       while(currentDate < endTime) {
//         let formattendTime = currentDate.toLocaleTimeString([], {hour:'2-digit', minute:'2-digit' })
      
//         // agregar ranura a la matriz
//         timeSlots.push({
//           datetime: new Date(currentDate),
//           time:formattendTime
//         })

//         // Incrementar el tiempo actual en 30 minutos
//         currentDate.setMinutes(currentDate.getMinutes() + 30)
//       }
...
//           <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0 '>
//             {/* --------doc info: nombre, grado, experincia ---------- */}
//             <p className='flex items-center gap-2 text-2xl font-medium text-gray-900'>
//               {docInfo.name} 
//               <img className="w-10 h-10" src={assets.verified_icon} alt="" />
//             </p>
